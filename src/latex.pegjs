...
math_token_
  ...
  / whitespace* superscript whitespace* x:math_token {return {kind:"superscript", content:x}}
  / whitespace* subscript whitespace* x:math_token {return {kind:"subscript", content:x}}
  / ignore
  / whitespace
  / .
